...
final class RankingFeatureCollectionViewCell: UICollectionViewCell {
    ...
    private lazy var inAppPurchageInfoLabel: UILabel = {
        let label = UILabel()
        label.text = "앱 내 구입"
    ...
    func setup(rankingFeature: RankingFeature) {
        ...
        inAppPurchageInfoLabel.isHidden = rankingFeature.isInPurchaseApp
    }
}
...
private extension RankingFeatureCollectionViewCell {
    func setupLayout() {
        ...
        inAppPurchageInfoLabel.snp.makeConstraints {
